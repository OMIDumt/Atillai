...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BXc6DZcI.mjs");
...
const manifest = {
  "5d03932537243d107b0e7c53e8305b7fe661ae80a427942cdc5dda664865ba53": {
    functionName: "chatConsult_createServerFn_handler",
    importer: () => import("./chat.functions-DHkuQaBS.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-On6b4iSk.mjs").then((n) => n.r),
    import("./start-C0q1tZpF.mjs"),
